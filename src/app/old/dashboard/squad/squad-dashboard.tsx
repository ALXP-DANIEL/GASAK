    ...
    <DashboardPanel
      ...
      action={
        <Button asChild variant="outline" size="sm">
          <Link href="/old/dashboard/profile">Edit Profile</Link>
        </Button>
      }
    >
      <div className="grid gap-5">
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button asChild variant="outline" size="sm" className="ml-auto">
              <Link href="/old/dashboard/profile">View All</Link>
            </Button>
          </div>
        </div>
      </div>
...
function MemberRecentScrimsPanel({
  ...
  return (
    <DashboardPanel
      ...
      action={
        <Button asChild variant="outline" size="sm">
          <Link href="/old/dashboard/scrims">View All</Link>
        </Button>
      }
    >
...
function UpcomingTournamentPanel({
  ...
  return (
    <DashboardPanel
      ...
      action={
        <Button asChild variant="outline" size="sm">
          <Link href="/old/dashboard/tournaments">View Details</Link>
        </Button>
      }
    >
      {tournament ? (
  ...
  return (
    <section className="relative overflow-hidden rounded-lg border border-primary/25 bg-card px-5 py-6 shadow-[0_0_50px_oklch(0.78_0.14_85_/_0.1)] md:px-7">
      ...
      <div className="relative flex flex-col gap-5 md:flex-row md:items-center">
        ...
        {squadSlug ? (
          <Button asChild variant="outline" size="sm">
            <Link href="/old/dashboard/my-squad">View Squad</Link>
          </Button>
        ) : null}
      </div>
    </section>
...
function LeaderEventsPanel({
  ...
  return (
    <DashboardPanel
      ...
      action={
        <Button asChild variant="outline" size="sm">
          <Link href="/old/dashboard/calendar">View Calendar</Link>
        </Button>
      }
    >
...
function LeaderAnnouncementsPanel({
  ...
  return (
    <DashboardPanel
      ...
      action={
        <Button asChild variant="outline" size="sm">
          <Link href="/old/dashboard/announcements">View All</Link>
        </Button>
      }
    >
      <div className="grid gap-3">
  ...
  return (
    <DashboardPanel
      ...
      action={
        isLeader ? (
          <Button asChild variant="outline" size="sm">
            <Link href="/old/dashboard/recruitment">View All</Link>
          </Button>
        ) : null
      }
    >
...
function PerformancePanel({
  ...
  return (
    <DashboardPanel
      ...
      action={
        <Button asChild variant="outline" size="sm">
          <Link href="/old/dashboard/scrims">View Statistics</Link>
        </Button>
      }
    >
...
function MembersPanel({
  ...
  return (
    <DashboardPanel
      ...
      action={
        <Button asChild variant="outline" size="sm">
          <Link href="/old/dashboard/my-squad">View All</Link>
        </Button>
      }
    >
