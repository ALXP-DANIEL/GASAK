...
export default async function SquadDetailPage(
  props: PageProps<"/old/squads/[slug]">,
) {
  ...
  return (
    <SquadAccent color={squad.accentColor}>
      <div className="flex flex-col gap-10">
        {squad.bannerUrl && (
          <div className="relative h-40 w-full overflow-hidden rounded-lg border border-primary/25 lg:h-56">
            <Image
              src={squad.bannerUrl}
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <h1 className="mt-2 font-heading text-3xl font-bold tracking-wide lg:text-4xl">
              {squad.name}
            </h1>
