...
function SquadOverviewPanel({
  ...
  return (
    <DashboardPanel
      ...
      description={
        <Link href="/dashboard/squads" className="hover:text-foreground">
          View all squads →
        </Link>
      }
    >
...
function RecruitmentFunnelPanel({
  ...
  return (
    <DashboardPanel
      ...
      description={
        <Link href="/dashboard/recruitment" className="hover:text-foreground">
...
function TournamentOverviewPanel({
  ...
  return (
    <DashboardPanel
      ...
      description={
        <Link href="/dashboard/tournaments" className="hover:text-foreground">
          View all →
        </Link>
      }
    >
