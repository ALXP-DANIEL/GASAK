      ...
      <section className="grid gap-8 border-b border-primary/20 pb-10 desktop:grid-cols-[minmax(0,1fr)_24rem] desktop:items-end">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-sm leading-7 text-muted-foreground desktop:text-base desktop:leading-8">
            Sponsorships, tournaments, business opportunities, squad inquiries,
            and community messages all start here. Pick the channel that matches
            your request and the team will route it properly.
          </p>
        </div>
        ...
        <BrandCard interactive={false} className="p-6">
          ...
          <p className="mt-3 text-sm leading-7 text-muted-foreground">
            Player applications are reviewed from the recruitment form so ranks,
            lanes, and hero pools stay organized.
          </p>
          <LinkButton
            href="/recruitment"
            variant="solid"
